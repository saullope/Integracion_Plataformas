<template>
<div class="bg-white-900 px-4 py-8 md:px-6 lg:px-8">
    <div class="grid">
        <div class="col-12 md:col-3 flex flex-wrap justify-content-start md:mb-0 mb-3">
            <Image src="../assets/logo_mediano.jpg" />
        </div>
        <div class="col-12 md:col-3">
            <div class="text-900 text-lg mb-4 flex flex-wrap" style="max-width: 290px;">Jacob Obrechtstraat 5, 1071 KC Amsterdam The Netherlands
            </div>
        ...
        <div class="col-12 md:col-3 text-gray-700">
            <div class="text-900 font-bold line-height-3 mb-3">Company
            </div>
        ...
        <div class="col-12 md:col-3 text-gray-700">
            <div class="text-900 font-bold line-height-3 mb-3">Resourses
            </div>
